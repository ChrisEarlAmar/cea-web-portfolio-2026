...
export default function Contact() {
  return (
    <section id="contact" className="py-24 bg-[#0a0f0d]">
              ...
              <div key={item.label}>
                {item.href ? (
                  <a
                    ...
                    className="flex items-center gap-4 p-4 bg-[#111915] rounded-xl border border-[#1F6F5F]/20 hover:border-[#2FA084]/40 transition-all duration-300 group"
                  >
                  ...
                  <div className="flex items-center gap-4 p-4 bg-[#111915] rounded-xl border border-[#1F6F5F]/20">
                    <div className={`w-12 h-12 bg-gradient-to-br ${item.color} rounded-xl flex items-center justify-center flex-shrink-0`}>
                      <item.Icon className="w-6 h-6 text-white" />
                    </div>
                    <div>
          ...
          <div className="p-8 bg-gradient-to-br from-[#1F6F5F]/20 to-[#2FA084]/20 rounded-2xl border border-[#1F6F5F]/20">
            ...
            <div className="space-y-4">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full px-6 py-4 bg-[#16241f] hover:bg-[#1a2a24] text-[#EEEEEE] font-medium rounded-xl transition-all duration-200 border border-[#1F6F5F]/30"
              >
